...
class EmergencyStatusScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('emergencyStatus')),
      ),
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                InfoCard(
                  title: context.tr('eta'),
                  value: currentTicket.eta.isEmpty
                      ? context.tr('notAvailable')
                      : currentTicket.eta,
                ),
                InfoCard(
                  title: context.tr('dateTime'),
                  value: DateFormatHelper.format(currentTicket.createdAt),
                ),
                InfoCard(
                ...
                const SizedBox(height: 20),
                PrimaryButton(
                  label: context.tr('callEmergencySupport'),
